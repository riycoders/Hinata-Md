...
exports.serialize = (fadly, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === fadly.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
    ...
    if (msg.key.fromMe){
        msg.sender = fadly.user.id.split(':')[0]+'@s.whatsapp.net'
    }
